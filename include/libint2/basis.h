...
namespace libint2 {
  ...
  class BasisSet : public std::vector<libint2::Shell> {
    public:
       ...
       *         <li> hardwired to directory \c /ccs/home/agriffith/libint_build/share/libint/2.5.0/basis </li>
       *       </ol>
       */
...
#else
          path = std::string("/ccs/home/agriffith/libint_build/share/libint/2.5.0") + std::string("/basis");
#endif
        }
        // validate path
        bool error = true;
