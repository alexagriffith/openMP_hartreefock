...
extern "C" {
#endif
void eri3_aB_D__0__F__1___TwoPRep_unit__0__F__1___Ab__up_0(const Libint_t* inteval) {
...
eri3_aB_D__0__F__1___TwoPRep_unit__0__F__1___Ab__up_0_prereq(inteval+c, inteval->stack);
}
...
{
const int vi = 0;
HRRPart1bra0ket0gp(inteval, &(inteval->stack[((hsi*270+1044)*1+lsi)*1]), &(inteval->stack[((hsi*126+168)*1+lsi)*1]), &(inteval->stack[((hsi*90+294)*1+lsi)*1]),6);
HRRPart1bra0ket0fp(inteval, &(inteval->stack[((hsi*180+1314)*1+lsi)*1]), &(inteval->stack[((hsi*90+294)*1+lsi)*1]), &(inteval->stack[((hsi*60+384)*1+lsi)*1]),6);
...
HRRPart1bra0ket0hp(inteval, &(inteval->stack[((hsi*378+1854)*1+lsi)*1]), &(inteval->stack[((hsi*168+0)*1+lsi)*1]), &(inteval->stack[((hsi*126+168)*1+lsi)*1]),6);
