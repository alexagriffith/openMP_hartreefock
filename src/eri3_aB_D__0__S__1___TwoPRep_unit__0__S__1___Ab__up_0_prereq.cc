...
extern "C" {
#endif
void eri3_aB_D__0__S__1___TwoPRep_unit__0__S__1___Ab__up_0_prereq(const Libint_t* inteval, LIBINT2_REALTYPE* parent_stack) {
...
fp15 = libint2::fma_minus(inteval->roz[vi], inteval->_aB_s___0__s___1___TwoPRep_s___0__s___1___Ab__up_1[vi], inteval->_aB_s___0__s___1___TwoPRep_s___0__s___1___Ab__up_0[vi]);
...
fp6 = libint2::fma_minus(inteval->WP_z[vi], fp18, fp14);
...
fp9 = libint2::fma_minus(inteval->WP_y[vi], fp19, fp14);
...
fp13 = libint2::fma_minus(inteval->WP_x[vi], fp20, fp14);
