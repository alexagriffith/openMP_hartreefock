...
extern "C" {
#endif
void eri3_aB_F__0__G__1___TwoPRep_unit__0__F__1___Ab__up_0(const Libint_t* inteval) {
...
eri3_aB_F__0__G__1___TwoPRep_unit__0__F__1___Ab__up_0_prereq(inteval+c, inteval->stack);
}
...
{
const int vi = 0;
HRRPart1bra0ket0hp(inteval, &(inteval->stack[((hsi*630+2500)*1+lsi)*1]), &(inteval->stack[((hsi*280+360)*1+lsi)*1]), &(inteval->stack[((hsi*210+640)*1+lsi)*1]),10);
HRRPart1bra0ket0gp(inteval, &(inteval->stack[((hsi*450+3130)*1+lsi)*1]), &(inteval->stack[((hsi*210+640)*1+lsi)*1]), &(inteval->stack[((hsi*150+850)*1+lsi)*1]),10);
...
HRRPart1bra0ket0ip(inteval, &(inteval->stack[((hsi*840+4480)*1+lsi)*1]), &(inteval->stack[((hsi*360+0)*1+lsi)*1]), &(inteval->stack[((hsi*280+360)*1+lsi)*1]),10);
