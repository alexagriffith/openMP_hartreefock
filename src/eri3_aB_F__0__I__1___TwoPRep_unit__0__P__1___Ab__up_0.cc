...
extern "C" {
#endif
void eri3_aB_F__0__I__1___TwoPRep_unit__0__P__1___Ab__up_0(const Libint_t* inteval) {
...
eri3_aB_F__0__I__1___TwoPRep_unit__0__P__1___Ab__up_0_prereq(inteval+c, inteval->stack);
}
...
const int lsi = 0;
const int vi = 0;
inteval->targets[0] = &(inteval->stack[((hsi*840+640)*1+lsi)*1]);
/** Number of flops = 0 */
}
