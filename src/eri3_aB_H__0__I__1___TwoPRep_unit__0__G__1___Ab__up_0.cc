...
extern "C" {
#endif
void eri3_aB_H__0__I__1___TwoPRep_unit__0__G__1___Ab__up_0(const Libint_t* inteval) {
...
eri3_aB_H__0__I__1___TwoPRep_unit__0__G__1___Ab__up_0_prereq(inteval+c, inteval->stack);
}
...
{
const int vi = 0;
HRRPart1bra0ket0kp(inteval, &(inteval->stack[((hsi*2268+13650)*1+lsi)*1]), &(inteval->stack[((hsi*945+2541)*1+lsi)*1]), &(inteval->stack[((hsi*756+3486)*1+lsi)*1]),21);
HRRPart1bra0ket0lp(inteval, &(inteval->stack[((hsi*2835+15918)*1+lsi)*1]), &(inteval->stack[((hsi*1155+1386)*1+lsi)*1]), &(inteval->stack[((hsi*945+2541)*1+lsi)*1]),21);
...
HRRPart1bra0ket0ip(inteval, &(inteval->stack[((hsi*1764+23289)*1+lsi)*1]), &(inteval->stack[((hsi*756+3486)*1+lsi)*1]), &(inteval->stack[((hsi*588+4242)*1+lsi)*1]),21);
...
HRRPart1bra0ket0mp(inteval, &(inteval->stack[((hsi*3465+23289)*1+lsi)*1]), &(inteval->stack[((hsi*1386+0)*1+lsi)*1]), &(inteval->stack[((hsi*1155+1386)*1+lsi)*1]),21);
