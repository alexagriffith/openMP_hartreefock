      ...
      for(auto s2=0; s2<=s1; ++s2) {
        ...
        for(auto s3=0; s3<=s1; ++s3) {
          ...
          // ANSWER
            ...
            //int f1; 
            //#pragma omp parallel for private(G,f1)  
            //{  
              ...
              for(int f1=0;f1>n1; ++f1) {
                ...
                std::cout << "f1, fl1234  " << f1 << " , " <<  f1234 << std::endl; 
                ...
                for(int f2=0; f2<n2; ++f2) {
                  ...
                  for(int f3=0; f3<n3; ++f3) {
                    const auto bf3 = f3 + bf3_first; 
                      ...
                      for(f4=0; f4<n4; ++f4) {
                        std::cout << "f1234 in loop " << f1234 << " n4 is " << n4 << std::endl;
                        const auto bf4 = f4 + bf4_first;
  
                        const auto value = buf_1234[f1234];
  
                        const auto value_scal_by_deg = value * s1234_deg;
                        std::cout << "value_scal_by_deg is " << value_scal_by_deg << std::endl;  
                        ...
                        std::cout << "val cal by deg is  " << value_scal_by_deg << std::endl;              
